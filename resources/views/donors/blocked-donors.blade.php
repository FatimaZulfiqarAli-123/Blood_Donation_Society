...
@section('title', 'Blocked Donors List')
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Blocked Donors List</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach ($blockedDonors as $donor)
                                    <tr>
                                        ...
                                        @role('admin')
                                            <td class="align-middle text-center">
                                                ...
                                                <a href="" data-bs-toggle="modal" data-bs-target="#unblockModal{{ $donor->id }}">
                                                    <i class="material-icons text-md mb-0 position-relative">lock</i>
                                                </a>
                                            ...
                                            <div class="modal fade mt-6" id="unblockModal{{ $donor->id }}" tabindex="-1" aria-labelledby="unblockModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-custom">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <h5>Do you want to unblock this Donor</h5>
                                                            <div>
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                <button type="button" class="btn btn-danger" onclick="document.getElementById('unblock-form{{ $donor->id }}').submit();">Unblock</button>
                                                            </div>
                                                            <form id="unblock-form{{ $donor->id }}" action="{{ route('donor.unblock', $donor->id) }}" method="POST" style="display: none;">
                                                                @csrf
                                                                @method('PUT')
                                                            </form>
                                                        </div>
